<section class="py-20 bg-[#050505] border-t border-white/5">
    ...
    <div class="swiper brain-trust-swiper px-6 lg:px-20 pb-10">
        ...
        <!-- Navigation Buttons -->
        <div class="flex items-center justify-between mt-8 px-6 lg:px-20">
            <div class="flex items-center gap-4">
                <button id="bt-prev" class="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white/10 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                </button>
                <button id="bt-next" class="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center text-white hover:bg-white/10 transition-colors">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center gap-3">
                <span class="text-white/40 text-sm">Progress</span>
                <div class="w-32 h-1 bg-white/10 rounded-full overflow-hidden">
                    <div id="bt-progress" class="h-full bg-brand-yellow w-0 transition-all duration-300"></div>
                </div>
            </div>
        </div>
    </div>
