<section class="relative min-h-[90vh] flex items-center px-6 lg:px-20 py-10 overflow-hidden bg-[#050505]">
    ...
    <div class="container mx-auto max-w-7xl relative z-10">
        {{-- Grid stacks on iPads/Tablets (xl: breakpoint) to prevent overlap --}}
        <div class="grid xl:grid-cols-12 gap-12 xl:gap-16 items-center">

            <div class="xl:col-span-7 space-y-10 md:space-y-14" 
                x-data="{ 
                    init() {
                ...
                <div class="relative space-y-6">
                    <div class="absolute -left-8 top-0 hidden 2xl:flex flex-col items-center gap-4 py-2">
                    ...
                    <h1 class="main-title group cursor-default font-black tracking-tighter uppercase text-white max-w-fit">
                        <span class="block text-6xl md:text-7xl lg:text-8xl leading-[0.8] transition-transform duration-500 group-hover:translate-x-2">
                            AXION
                        </span>
                        
                        {{-- Flex-col ensures 'Group' is always under 'International' --}}
                        <span class="stroke-text flex flex-col text-4xl md:text-6xl lg:text-7xl leading-none text-transparent transition-all duration-500 group-hover:drop-shadow-[0_0_15px_rgba(230,177,46,0.4)] mt-4" 
                              style="-webkit-text-stroke: 1.5px rgba(230,177,46,0.8);">
                    ...
                    <div class="flex items-center gap-6 group cursor-default">
                        <div class="h-[2px] w-12 bg-brand-yellow transition-all duration-500 group-hover:w-20 shrink-0"></div>
                        <p class="text-xs md:text-sm lg:text-md font-bold text-white/90 tracking-[0.15em] uppercase italic transition-all duration-500 group-hover:translate-x-2">
            ...
            {{-- VIDEO COLUMN --}}
            <div class="xl:col-span-5 relative mt-12 xl:mt-0 w-full">
                <div class="relative w-full aspect-video xl:aspect-square rounded-xl overflow-hidden shadow-2xl border border-white/10 group">
                    ...
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
                </div>
            </div>
        </div>
    </div>
