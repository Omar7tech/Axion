        ...
        <div class="flex flex-col lg:flex-row justify-between items-start gap-8 lg:gap-12 mb-10">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-x-16 lg:gap-y-8 w-full lg:w-auto">
                ...
                <div class="space-y-3">
                    ...
                    <ul class="text-base font-light uppercase tracking-[0.1em] space-y-1 text-white/50">
                        <li><a href="{{ route('about-us') }}" wire:navigate
                                class="hover:text-white transition-colors">About</a></li>
                        <li><a href="{{ route('global-partnerships') }}" wire:navigate
                                class="hover:text-white transition-colors">Partners</a></li>
                        <li><a href="{{ route('careers.index') }}" wire:navigate
                                class="hover:text-white transition-colors">Careers</a></li>
                    </ul>
                </div>
                ...
                <div class="space-y-3 sm:col-span-2 lg:col-span-1">
                    ...
                    <div class="space-y-3">
                        <a href="mailto:support@axion.com"
                            class="block text-lg sm:text-xl font-light text-white hover:text-brand-yellow transition-colors tracking-tight uppercase">support@axion.com</a>
