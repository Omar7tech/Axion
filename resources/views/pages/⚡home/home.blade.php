    ...
    <footer class="relative pt-24 pb-10 px-6 lg:px-20 overflow-hidden bg-brand-black">
        ...
        <div class="container mx-auto max-w-7xl relative z-10">
            ...
            <div class="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-10 mb-20">
                <div class="space-y-6">
                    <h5 class="text-4xl font-black uppercase tracking-tighter italic">Axion<span class="text-brand-yellow">.</span></h5>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-12 py-16 border-y border-white/5">
                <div class="space-y-6">
                    ...
                    <ul class="text-[10px] uppercase tracking-widest space-y-4 text-white/50">
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Architecture</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Global Trading</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Digital Assets</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Development</a></li>
                    </ul>
                </div>
                <div class="space-y-6">
                    <h6 class="text-[11px] font-black uppercase tracking-[0.3em] text-brand-yellow">Company</h6>
                    <ul class="text-[10px] uppercase tracking-widest space-y-4 text-white/50">
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">About Axion</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Sustainability</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Partnerships</a></li>
                        <li><a href="#" class="hover:text-brand-yellow hover:translate-x-1 transition-all inline-block">Careers</a></li>
                    </ul>
                </div>
                <div class="space-y-6">
                    <h6 class="text-[11px] font-black uppercase tracking-[0.3em] text-brand-yellow">Connect</h6>
                    <div class="flex gap-4">
                        <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-[10px] hover:bg-brand-yellow hover:text-black transition-all">LN</a>
                        <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-[10px] hover:bg-brand-yellow hover:text-black transition-all">TW</a>
                        <a href="#" class="w-10 h-10 border border-white/10 flex items-center justify-center text-[10px] hover:bg-brand-yellow hover:text-black transition-all">IG</a>
                    </div>
                </div>
                <div class="space-y-6 relative">
                    <h6 class="text-[11px] font-black uppercase tracking-[0.3em] text-brand-yellow">Newsletter</h6>
                    <div class="flex">
                        <input type="email" placeholder="EMAIL ADDRESS" class="bg-white/5 border border-white/10 px-4 py-3 text-[10px] w-full focus:outline-none focus:border-brand-yellow/50 transition-colors uppercase">
